...
\begin{equation}
    \begin{aligned}
        \operatorname{Var}(R) 
        &= \operatorname{Var}\left(\sum_{i}^{N} w_{i} r_{i}\right) \\
        &= \sum_{i}^{N} w^2_{i} \operatorname{Var}(r_{i}) 
    ...
    \end{aligned}
\end{equation}
where $\operatorname{Var}(r_i)=\sigma^2_i$ and 
$\operatorname{Cov}(r_i,r_j)=\sigma_{i,j}$.
