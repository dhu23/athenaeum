...
When it is small, it is the same as the logrithmic return which is usually
modeled by a normal distribution, $r_i \sim \mathcal{N}(\mu_i, \sigma^2_i)$.
Then we can compute the portfolio return $R$ as a function of 
the random variables $r_i$.
\begin{equation}
    \begin{aligned}
